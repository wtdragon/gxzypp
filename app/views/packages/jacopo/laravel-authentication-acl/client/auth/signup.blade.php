        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title bariol-thin">请使用email地址进行注册</h3>
                </div>
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        {{Form::text('first_name', '', ['id' => 'first_name', 'class' => 'form-control', 'placeholder' => '姓', 'required', 'autocomplete' => 'off'])}}
                                    </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                        {{Form::text('last_name', '', ['id' => 'last_name', 'class' => 'form-control', 'placeholder' => '名', 'required', 'autocomplete' => 'off'])}}
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        {{Form::password('password', ['id' => 'password1', 'class' => 'form-control', 'placeholder' => '密码', 'required', 'autocomplete' => 'off'])}}
                                    </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                        {{Form::password('password_confirmation', ['class' => 'form-control', 'id' =>'password2', 'placeholder' => '确认密码', 'required'])}}
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        {{Form::text('captcha_text',null, ['class'=> 'form-control', 'placeholder' => '填写图片中的验证码', 'required', 'autocomplete' => 'off'])}}
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 margin-top-10">
                        {{link_to_action('Jacopo\Authentication\Controllers\AuthController@getClientLogin','已经有帐号了吗？点此登录')}}
                    </div>
                </div>
                </div>
            </div>
